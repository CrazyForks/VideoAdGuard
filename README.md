...
1. **浏览器插件版**：安装完成后，点击插件图标完成设置
   ...
   ![](https://imgbed.xiaobaozi.cn/file/blog/VideoAdGuard_popup1.png)
2. **油猴脚本版**：安装完成后，进入B站视频页面，点击右下角齿轮图标进行设置

   ![](https://imgbed.xiaobaozi.cn/file/blog/VideoAdGuard2.png)
...
- ![与后端api通信的请求在这里查看](https://imgbed.xiaobaozi.cn/file/blog/插件管理界面.png)
